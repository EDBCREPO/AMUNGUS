...
namespace ungine { namespace controller {
    ...
    node_t world() { return node::node_3D([]( ptr_t<node_t> self ){
        ...
        self->get_viewport()->background = color::hex( "00000000" );
    ...
    //  self->on2D([=](){ rl::DrawFPS ( 10 , 10 ); });
        ...
        material_t onMain( material_t mat ){
            ...
            if( flag == 2. ){
                ...
                mat.fragment= vec4( vec3( 0.,1.+n,0. ) * line*
            ...
            ) * line, mat.model  ); return mat; }

            mat.fragment = vec4( mat.albedo * mat.light * line, mat.model ); 
